        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-federation/20 to-night border border-federation/30 rounded-lg p-6 mb-4">
              ...
              <a
                href="#contato"
                className="flex items-center justify-center gap-2 font-display text-night bg-gold hover:bg-gold-light py-3 rounded-lg tracking-wider transition-colors duration-250"
              >
